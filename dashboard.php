			...
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-teal panel-widget border-right">
					<div class="row no-padding"><em class="fa fa-xl fa-bed color-blue"></em>
						...
						<div class="text-muted"><?php _e('dashboard_total_rooms') ?></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-blue panel-widget border-right">
					<div class="row no-padding"><em class="fa fa-xl fa-bookmark color-orange"></em>
						...
						<div class="text-muted"><?php _e('dashboard_total_reservations') ?></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-orange panel-widget border-right">
					<div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
						...
						<div class="text-muted"><?php _e('dashboard_total_staff') ?></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-red panel-widget ">
					<div class="row no-padding"><em class="fa fa-xl fa-comments color-red"></em>
						...
						<div class="text-muted"><?php _e('dashboard_total_complaints') ?></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-teal panel-widget border-right">
					<div class="row no-padding"><em class="fa fa-xl fa-reorder color-red"></em>
						...
						<div class="text-muted"><?php _e('dashboard_occupied_rooms') ?></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-blue panel-widget border-right">
					<div class="row no-padding"><em class="fa fa-xl fa-check-circle color-green"></em>
						...
						<div class="text-muted"><?php _e('dashboard_available_rooms') ?></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<div class="panel panel-orange panel-widget border-right">
					<div class="row no-padding"><em class="fa fa-xl fa-check-square-o color-magg"></em>
						...
						<div class="text-muted"><?php _e('dashboard_checked_in') ?></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
